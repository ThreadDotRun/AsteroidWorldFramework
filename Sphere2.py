...
class Sphere:
	def __init__(self, x: float, y: float, z: float, grid_size_z: float, radius: float, engine: ShowBase, texture_path: str = None, model_name='.\\models\\namaqualand_boulder_03_4k.egg', accorgrav=1, rotate_x=0):
